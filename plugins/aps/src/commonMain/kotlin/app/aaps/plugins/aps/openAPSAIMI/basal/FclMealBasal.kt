 ...
 *
 * Source: `origin/dev_OAPSAIMI` @ `3dd116826a` then `41e59f9bc0` (file SHA `5a9ad2a4b5`, unchanged
 * on tip `aaa30588f7`). Study wiring: commonMain `internal object` (pure, no instance state).
 * No Locale / Hilt / File. Clinical formulas, ceilings, and stand-downs are unchanged.
 */
internal object FclMealBasal {
