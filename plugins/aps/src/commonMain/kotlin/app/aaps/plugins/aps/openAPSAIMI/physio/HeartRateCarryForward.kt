 ...
 *
 * Source: `origin/dev_OAPSAIMI` @ `9d0e9bdb9f` (file unchanged on tip `f61474bb73`).
 * Study wiring: commonMain shared `object` — pure, no clock, no Android. KMP adaptation: none;
 * the clinical constants and [resolve] are bit-identical to the reference.
 */
