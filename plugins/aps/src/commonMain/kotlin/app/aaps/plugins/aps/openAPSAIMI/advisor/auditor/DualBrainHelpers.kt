...
object DualBrainHelpers {
    ...
    fun combineAdvice(
        ...
        return CombinedAdvice(
            ...
            externalRecommendation = external.verdict::class.simpleName ?: "UNKNOWN"
        )
    }
}
...
data class CombinedAdvice(
    ...
    fun toLogString(): String {
        ...
        if (appliedExternal && externalConfidence != null) {
            parts.add("External: ${externalRecommendation ?: "N/A"} conf=${aimiFmt2(externalConfidence)}")
        }
        
        parts.add("Final: smb×${aimiFmt2(smbFactor)} +${extraIntervalMin}m preferBasal=$preferBasal")
