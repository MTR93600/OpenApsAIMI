 ...
 *
 * Source: `origin/dev_OAPSAIMI` @ `6a6561caab`. Study: commonMain `internal object` — pure arithmetic,
 * no clock, no Android. [kotlin.concurrent.Volatile] replaces the JVM annotation. Clinical constants
 * and [finalize] / [raiseToStressFloor] match that commit.
 */
