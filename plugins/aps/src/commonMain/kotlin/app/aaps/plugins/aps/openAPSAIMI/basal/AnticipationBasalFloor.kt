 ...
 *
 * Source: `origin/dev_OAPSAIMI` @ `bce972221c` (file SHA `4cd866d936`, unchanged on tip `aaa30588f7`).
 * Study wiring: commonMain `internal object` (pure, no instance state). No Locale / Hilt / File.
 * Clinical formulas, thresholds, and stand-downs are unchanged.
 */
internal object AnticipationBasalFloor {
