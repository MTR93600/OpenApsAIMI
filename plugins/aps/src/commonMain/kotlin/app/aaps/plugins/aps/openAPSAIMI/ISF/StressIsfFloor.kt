 ...
 *
 * Source: `origin/dev_OAPSAIMI` @ `e87cb03e87` + `9d0e9bdb9f` (file unchanged on tip `f61474bb73`).
 * Study wiring: commonMain shared `object` — pure, no clock, no Android. KMP adaptation only:
 * [aimiFmt1] for one-decimal reason fragments. Clinical constants and [evaluate] are otherwise
