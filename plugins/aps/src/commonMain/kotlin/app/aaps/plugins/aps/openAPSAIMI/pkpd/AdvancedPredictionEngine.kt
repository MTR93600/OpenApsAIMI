...
object AdvancedPredictionEngine {
    ...
    // Freeze Constants.PREDICTION_GRAPH_MIN_MINUTES (2 h). kmp Constants dropped the AIMI graph keys.
    private const val PREDICTION_GRAPH_MIN_MINUTES = 120
    ...
    fun predictCurves(
        ...
        val effectiveHorizonMinutes = maxOf(PREDICTION_GRAPH_MIN_MINUTES, horizonMinutes)
