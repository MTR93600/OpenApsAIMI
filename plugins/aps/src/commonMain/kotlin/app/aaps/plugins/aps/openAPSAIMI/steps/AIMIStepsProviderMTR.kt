...
interface AIMIStepsProviderMTR {
     ...
     */
    fun getStepsDelta(windowMinutes: Int, now: Instant = Clock.System.now()): Int
     ...
     */
    fun getStepsPerMinute(windowMinutes: Int, now: Instant = Clock.System.now()): Double {
     ...
     */
    fun getStepsBatch(windowsMinutes: List<Int>, now: Instant = Clock.System.now()): Map<Int, Int> {
