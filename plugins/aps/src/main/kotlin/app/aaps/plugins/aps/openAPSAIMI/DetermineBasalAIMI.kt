...
class DetermineBasalaimiSMB @Inject constructor(
    ...
    private fun isLunch2ModeCondition(): Boolean{
        ...
        val modeLunchPB2 = lunchruntime in 15..24 && lastBolusSMBUnit != pbolusLunch2.toFloat() && lunchTime
        return modeLunchPB2
    }
    ...
    private fun isDinner2ModeCondition(): Boolean{
        ...
        val modeDinnerPB2 = dinnerruntime in 15..24 && lastBolusSMBUnit != pbolusDinner2.toFloat() && dinnerTime
    ...
    private fun neuralnetwork5(delta: Float, shortAvgDelta: Float, longAvgDelta: Float, predictedSMB: Float, basalaimi: Float): Pair<Float, Float> {
        ...
        for (globalIteration in 1..maxGlobalIterations) {
            ...
            while (globalIterationCount < maxGlobalIterations && !globalConvergenceReached) {
                ...
                val epochs = if (tir1DAYabove > 15 || bg < 130) 10000.0 else 100.0
    ...
    fun determine_basal(
        ...
        this.acceleratingUp = if (delta > 4 && delta - longAvgDelta > 4) 1 else 0
        ...
        var rate = when {
            iob < 0.4 && bg > 118 -> profile_current_basal
