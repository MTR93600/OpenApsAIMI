...
internal class TherapyNotePersistence(private val events: List<TE>) : PersistenceLayer {
    ...
    override suspend fun insertPumpTherapyEventIfNewByTimestamp(therapyEvent: TE, timestamp: Long, action: Action, source: Sources, note: String?, listValues: List<ValueWithUnit>): TransactionResult<TE> = unused()
