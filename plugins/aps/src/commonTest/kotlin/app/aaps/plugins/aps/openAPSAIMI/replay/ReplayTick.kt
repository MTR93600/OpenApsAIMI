 ...
 *
 * Study port of `79588b42cb`. Parsing uses kotlinx `JsonObject`, not `org.json` (Android / JVM).
 * This is the APS barrier harness — not [app.aaps.plugins.aps.openAPSAIMI.quality.ReplayQualityExport].
 */
data class ReplayTick(
    ...
    companion object {
        ...
        fun fromJson(line: String): ReplayTick {
            ...
            return ReplayTick(
                timestampMs = o.lng("t") ?: error("ReplayTick JSON is missing required key t"),
                trigger = o.str("trig"),
                bgMgdl = o.dbl("bg"),
                iobU = o.dbl("iob"),
                cobG = o.dbl("cob"),
                profileIsfMgdl = o.dbl("pisf"),
                profileBasalUph = o.dbl("pbasal"),
                staticIsfMgdl = o.dbl("sisf"),
                commandIsfMgdl = o.dbl("cisf"),
                isfSource = o.str("isrc"),
                isfAgeMs = o.lng("iage"),
                decision = o.str("dec"),
                smbU = o.dbl("amt") ?: 0.0,
                basalUph = o.dbl("basal"),
                originOwner = o.str("owner"),
                finalOwner = o.str("fowner"),
                maxSmbU = o.dbl("maxsmb"),
                iobHeadroomU = o.dbl("iobhead"),
                correctionAggressionTier = o.str("tier"),
                safetySource = o.str("safety"),
                postHypoGuardState = o.str("phguard"),
                patientMode = o.str("pmode"),
                targetBgMgdl = o.dbl("tgt"),
                mealModeActive = o.bool("mealmode"),
                postHypoActive = o.bool("posthypo"),
                safetyGate = o.str("sgate"),
                haltRemainingPipeline = o.bool("halt"),
                uamDominant = o.str("uam"),
                absorptionPhase = o.str("absorb"),
                physiologicalPhase = o.str("phase"),
                dynamicIsfMgdl = o.dbl("disf"),
                eventualMgdl = o.dbl("ev"),
                minPredMgdl = o.dbl("minpred"),
                postHypoAuthorityActive = o.bool("phd_active"),
                postHypoAuthorityReason = o.str("phd_reason"),
                smbBeforeCapU = o.dbl("phd_before"),
                smbAfterCapU = o.dbl("phd_after"),
                offsetMinutes = o.dbl("tmin"),
                bgVelocityMgdlPerMin = o.dbl("vel"),
                maxIobU = o.dbl("maxiob"),
                lgsThresholdMgdl = o.dbl("lgs"),
                cbfPermittedU = o.dbl("cbfu"),
                cbfPermittedUnflooredU = o.dbl("cbfuunf"),
                cbfCoefficientUsed = o.dbl("cbfc"),
                cbfCoefficientUnfloored = o.dbl("cbfcunf"),
                cbfProfileIsfMgdl = o.dbl("cbfisf"),
                cbfHMgdl = o.dbl("cb_h"),
                cbfLfhMgdlPerMin = o.dbl("cb_lfh"),
                cbfLghMgdlPerUPerMin = o.dbl("cb_lgh"),
                cbfInsulinTermMgdlPerMin = o.dbl("cb_ins"),
                cbfSiMetabolic = o.dbl("cb_si"),
                cbfActiveGamma = o.dbl("cb_gam"),
                cbfSafetyBoundary = o.dbl("cb_bnd"),
                cbfSystemEvolution = o.dbl("cb_evo"),
                cbfSafeU = o.dbl("cb_safeu"),
                cbfFullySuspended = o.bool("cb_susp"),
                cbfAnchorIsDynamicIsf = o.bool("cb_anch"),
                cbfMpcRawSmbU = o.dbl("cb_rsmb"),
                cbfMpcRawTbrUph = o.dbl("cb_rtbr"),
            )
        }
        ...
        private fun JsonObject.dbl(key: String): Double? {
            val el = this[key] ?: return null
            if (el is JsonNull) return null
            val primitive = el.jsonPrimitive
