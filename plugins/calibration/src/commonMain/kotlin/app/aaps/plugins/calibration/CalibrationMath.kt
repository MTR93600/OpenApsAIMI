...
//
// Ref `CalibrationMath.kt` L23–32 and L33–73 @ `6598201d` (`1b81e356c8`, then `c653fc4485` for the
// low-end floor). The geometric line in this comment is not what `fitLinearCalibration` returns for
// those two points: fewer than [MIN_ENTRIES_FOR_SLOPE] entries are offset-only.
 ...
 *
 * Ref `CalibrationMath.kt` L37–62 @ `6598201d` (`c653fc4485`).
 */
 ...
 *
 * Ref `CalibrationMath.kt` L66–73 @ `6598201d`.
 */
 ...
 *
 * Ref `CalibrationMath.kt` L79–87 @ `6598201d`, used at L192 (`1b81e356c8`).
 */
...
data class CalibrationFit(
     ...
     *
     * Ref `CalibrationMath.kt` L148–155 @ `6598201d` (`c653fc4485` dropped the old −30 floor).
     */
     ...
     *
     * Ref `CalibrationMath.kt` L157–161 @ `6598201d`.
     */
